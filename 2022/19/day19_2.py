...
for blueprint in tqdm(blueprints):
    ...
    start = (1, 0, 0, 0, 0, 0, 0, 0, 32) # 32 is in minutes for part 2, and the 1 stands for one ore robot according to puzzle text
    q = deque([start])
    processed = set()
    ...
    result.append(max_geodes_blueprint)

res = 1
for max_geodes in result:
    res *= max_geodes
